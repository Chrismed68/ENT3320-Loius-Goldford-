...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 581.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "append cr"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.0, 615.0, 37.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 537.0, 200.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 504.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "$3 $4 $2 $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 152.0, 312.0, 469.0, 22.0 ],
					"style" : "",
					"text" : "t l l b b"
				}
...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "rtcmix~", 1, 0, ";", "#X", "restore", 0, 216, 216, "actualwave = maketable(\"wave\", 2000, \"tri\")\r\nampenv = maketable(\"line\", 1600, 0,1, 2,1, 4,0.5, 6,0.75, 8,0)\r\n\r\npitch = $1\r\namp = $2\r\nonset = $3\r\ndur = $4\r\n\r\nWAVETABLE(0, dur, amp * ampenv/2.1, pitch, 1.7, actualwave)", ";" ],
					"style" : "",
					"text" : "rtcmix~"
				}
