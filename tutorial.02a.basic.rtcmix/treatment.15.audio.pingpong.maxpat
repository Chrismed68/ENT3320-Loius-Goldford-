...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 199.0, 82.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 							{
								"filename" : "/Users/student/Desktop/Club Penguin Vietnam War with Improved Audio and Sound Effects.wav",
								"filekind" : "audiofile",
								"loop" : 0,
								"content_state" : 								{
									"mode" : [ "basic" ],
...
,
					...
					"patching_rect" : [ 315.0, -2.0, 557.0, 250.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.5, 153.571426, 125.0, 40.0 ],
...
, 			{
				"name" : "Club Penguin Vietnam War with Improved Audio and Sound Effects.wav",
				"bootpath" : "~/Desktop",
				"patcherrelativepath" : "../..",
				"type" : "WAVE",
				"implicit" : 1
